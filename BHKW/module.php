...
//}
	...
	class BHKW extends IPSModule {
		...
		use BHKWFunctions, BHKWZusatzHeizung, BHKWstatePP, BHKWstatePower, BHKWstateHeatControl, BHKWerrors, BHKWvaluePP, BHKWstateExternal, BHKWInfo, BHKWCreateProfile, BHKWCMD;
		...
		public function Create()
		{
			...
			if($HWID === false)
			{
				...
				$this->RegisterVariableString("GeraeteFirmware", "Geräte Firmware", "", 50);
			...
			$this->RegisterVariableFloat("VorlaufTemperaturSoll", "Vorlauf Temperatur soll", "~Temperature", 536);
			...
			$this->RegisterVariableFloat("Wartungzaehler", "letzte Wartung", "Kirsch.Std", 561);
						$this->RegisterVariableString("Wdate", "Wartungs Datum", "", 562);
